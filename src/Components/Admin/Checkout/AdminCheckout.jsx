            ...
            <div className="container-fluid my-4">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h4 className="bg-primary text-white text-center p-3 rounded">Checkout </h4>
                                    ...
                                    </tr>
                                    {
                                        data.map((item, index) => {
                                            return <tr key={index}>
                                                ...
                                                <Link to={`/admin-single-checkout/${item.id}`}><button className='btn text-primary'><i className='fa fa-eye'></i></button></Link>
                                                </td>
