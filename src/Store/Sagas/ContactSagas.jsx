import { createData, getData, updateData, deleteData } from "./Services/ContactService"
import { ADD_CONTACT, ADD_CONTACT_RED, GET_CONTACT, GET_CONTACT_RED, UPDATE_CONTACT, UPDATE_CONTACT_RED, DELETE_CONTACT, DELETE_CONTACT_RED } from '../Constant'
